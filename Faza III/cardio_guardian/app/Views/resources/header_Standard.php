...
<header class="w3-bar w3-padding-12  w3-mobile" style="background-color:rgb(216, 57, 43)">
    ...
    <a href="<?= site_url() ?>" class="w3-bar-item w3-button letters"><i class="fa fa-bar-chart"></i> Modul 1</a>
    <a href="<?= site_url() ?>" class="w3-bar-item w3-button letters"><i class="fas fa-running"></i> Modul 2</a>
    <a href="<?= site_url() ?>" class="w3-bar-item w3-button letters"><i class="fas fa-pizza-slice"></i> Modul 3</a>
